...
/**
 * Router de Programas — Cardio-Oncología Marie Curie.
 *
 * Basado en el Router de FooMedical 5.1.27, con dos cambios:
 *   + ruta `check-in` — autorreporte cardio-oncológico
 *   − ruta `membership-and-billing` — la facturación viene heredada de
 *     FooMedical y no aplica a un hospital público. Sacarla además cierra una
 *     superficie de acceso: `PaymentNotice` no está en la AccessPolicy del
 *     paciente, así que la página daría 403.
 */
...
export function Router(): JSX.Element {
  return (
    <Routes>
      ...
      {/* Autorreporte cardio-oncológico — el formulario lo define el servidor. */}
